...
// Static replacements
const postReq = () => Promise.resolve({ data: { messages: [] } });
const back = 'https://via.placeholder.com/800x600.png?text=Chat+Background';
const wp_back =
  'https://via.placeholder.com/800x600.png?text=Template+Background';
const QuickReplayList = [
  { title: 'Greeting', description: 'Hello! How can I help you today?' },
  {
    title: 'Closing',
    description: 'Thank you! Let me know if you need anything else.',
  },
];
const getBoldStr = (text) => text;
const templateCatgList = [
...
const LiveChat = () => {
  ...
  const url = 'https://example.com/api'; // dummy placeholder
  ...
  const dataArray = [
    ...
    },
    {
      ...
      name: 'Charlie Brown',
      status: 'Online',
      imageSrc: 'https://picsum.photos/id/241/200/300',
    },
    {
      id: 7,
      name: 'Charlie Brown',
  ...
  const handleSendMessage = () => {
    if (newMessage.trim() !== '' || storeMedia.media) {
      ...
      if (newMessage.trim() !== '') {
        ...
        newMessages.push({
          image: storeMedia.media_display,
          sender: 'user',
          imgText: mediaText,
          timeStamp: currentMessageTime(),
        });
        ...
        console.log(storeMedia.media);
        newMessages.push({
          video: storeMedia.media_display,
          sender: 'user',
          videoText: mediaText,
          timeStamp: currentMessageTime(),
        });
  ...
  const filteredTempData = selectedCategory
    ? templatesDataList.filter(
...
const data = () => {
  console.log(
    'Simulating message POST request with current messages:',
    messages
  );
};
  ...
  return (
    ...
    `}</style>
      ...
      <Container className='d-flex flex-column flex-grow-1 '>
        ...
        >
          <Row
            className='d-flex justify-content-center match-height'
            style={{
              background: '#eff6ff',
              height: '90vh',
              marginTop: '-20px',
          ...
          >
            ...
            <Col sm='3' className='px-0' style={{ background: '#fff' }}>
              <div
                ...
                style={{ background: '#f0f2f5', height: '65pxs' }}
              >
                <div className='d-flex align-items-center'>
                  <BiSolidUserCircle
                    style={{ height: '40px', width: '40px', color: '#dfe5e7' }}
                  />
                </div>
                <div>
                  <FaEllipsisV />
              ...
              <div className='m-1' style={{ borderRadius: '5px' }}>
                <InputGroup>
                  <InputGroupText
                    color='transparent'
                    style={{ border: '0', background: '#f0f2f5' }}
                  >
                ...
                <Row className='flex-column'>
                  {filteredData.map((data, index) => (
                    <Col
                      key={index}
                      style={{
                        background: selectedDiv === index ? '#f0f2f5' : 'white',
                      }}
                      onClick={() => {
                    ...
                    >
                      <div>
                        <div
                          className='d-flex mx-1 justify-content-between align-items-center border-bottom '
                          style={{ height: '65px' }}
                        >
                          <div className='d-flex align-items-center cursor-pointer'>
                            ...
                            >
                              ...
                              <p className='fs-3 fw-bolder text-white mb-0'>
                                {data.name[0]}
                              </p>
                            </div>
                            <p
            ...
            <Col
              ...
              style={{ backgroundImage: `url(${back})`, height: '100%' }}
            >
              {/* Header */}
              <div
              ...
              >
                <div
                  className='d-flex align-items-center ps-1 cursor-pointer w-100 '
                  style={{ background: '#f0f2f5', height: '65px' }}
                  onClick={() => setDynamicColumnValue(3)}
                >
                  <div
                    className='rounded-circle overflow-hidden d-flex align-items-center justify-content-center'
                    style={{
              ...
              <div
                className='chat-container d-flex flex-column  position-relative'
              ...
              >
                {!imagePreview ? (
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            alignSelf: ` ${
                              usePojectContact === data.sender ? 'end' : 'start'
                            }`,
                            ...
                            <div style={{ width: '371px' }}>
                              ...
                              {data.imgText && (
                                <div
                                  ...
                                  style={{ marginTop: '5px' }}
                                >
                                  <p className='mb-0 text-break w-80'>
                                    {data.imgText}
                                  </p>
                                  <div
                                    className='message-info align-items-end w-20'
                                    style={{
                                      textAlign: 'right',
                                      color: '#707B7C',
                                      wordBreak: 'normal',
                            ...
                            <div style={{ width: '300px' }}>
                              ...
                              {data.videoText && (
                                ...
                                >
                                  ...
                                  <div
                                    className='message-info align-items-end'
                                    style={{
                                      textAlign: 'right',
                                      color: '#707B7C',
                                    }}
                  ...
                  <div
                    ...
                    style={{ height: '100%', background: '#e9edef' }}
                  >
                    <div className=''>
                      <RxCross2
                        className='fs-3 '
                    ...
                    <div className='d-flex align-items-center  justify-content-center '>
                      ...
                      {storeMedia.media.type.startsWith('video/') ? (
                        <video controls width='250'>
                          <source
                            src={storeMedia.media_display}
                            type={storeMedia.media.type}
                          />
                        </video>
                      ) : (
                        <img
                ...
                {!imagePreview && (
                  <div
                    className=' d-flex align-items-center gap-1 px-1 position-sticky bottom-0 bg-white'
                    style={{ padding: '10px' }}
                  >
                    <div
                      className='btn'
                    ...
                    {toggleMedia && (
                      <div
                        className='bg-white position-absolute p-1 '
                        style={{
                          bottom: '60px',
                          left: '20px',
                          width: '200px',
                        ...
                        <Row className='d-flex flex-column gap-1'>
                          <Col>
                            <label
                              ...
                              htmlFor='uploadDocButton'
                              className='d-flex gap-1 cursor-pointer'
                            >
                              <File size={17} style={{ color: '#7f66ff' }} />{' '}
                              Documents
                              <input
                                type='file'
                                id='uploadDocButton'
                          ...
                          <Col>
                            ...
                            >
                              <Image size={17} style={{ color: '#007bfc' }} />
                              Photos
                              <input
                                name='media'
                          ...
                          <Col>
                            <label
                              ...
                              className='d-flex gap-1'
                            >
                              <Video size={17} style={{ color: '#007bfc' }} />
                              Videos
                              <input
                                name='media'
                                onChange={handleChange}
                    ...
                    />
                    <div
                      className='btn btn-primary send-btn d-flex justify-content-center gap-1 align-items-center '
            ...
            {dynamicColumnValue === 3 &&
              (search ? (
                <Col md={dynamicColumnValue} style={{ background: '#fff' }}>
                  <div
                    className='d-flex align-items-center gap-1 fs-4'
                  ...
                  <div
                    className='m-1 border border-secondary-subtle'
                ...
                <Col md={dynamicColumnValue} style={{ background: '#f0f2f5' }}>
                  ...
                  >
                    <RxCross2
                      onClick={() => setDynamicColumnValue(0)}
                      className='ms-1'
                    />
                  ...
                  <div
                    style={{
                      background: '#ffffff',
                      boxShadow: '0px 15px 11px -16px rgba(0,0,0,0.1)',
                    }}
                  >
                    <div className='d-flex flex-column align-items-center p-1'>
                      ...
                      >
                        <p
                          className='text-white fw-bolder mb-0'
                          style={{ fontSize: '5rem' }}
                        >
                          {text[0]}
                        </p>
                    ...
                    >
                      {QuickReplayList.map((item, index) => {
                        return (
                          ...
                          >
                            <div className='p-1 fw-bolder '>{item.title}</div>
                          </div>
                        );
                      })}
                    </div>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      setMessages((prevMessages) => [
                        ...prevMessages,
                        {
                          text: selectedDescription.description,
                          sender: 'user',
                          timeStamp: currentMessageTime(),
                        },
                      ]);
                      ...
                      {filteredTempData.map((SingleTemplate) => {
                        return (
                          <Col md='6 mt-3'>
                            ...
                            <Card
                              className='border-0 p-2 position-relative  shadow-lg'
                              style={{
                                background: '#c2c2c2',
                            ...
                            >
                              <div
                                className='border-1 rounded-3 mb-0 whatsapp_template_card'
                                style={{
                                  minHeight: '200px',
                                  background: 'white',
                                }}
                              >
                                <div className='p-0'>
                                  {SingleTemplate.components.map(
                                    (data, index) => {
                                      if (data.format === 'IMAGE') {
                                        return (
                                          <div className='p-1'>
                                            <img
                                              className=' img-fluid border-0 rounded w-100 object-fit-cover '
                                              src={
                                                data.example.header_handle[0] ??
                                                ''
                                              }
                                              alt=''
                                            />
                                      ...
                                      if (data.type === 'FOOTER') {
                                        return (
                                          <div className='pt-1 ps-1 pe-2'>
                                            <p className='text-secondary font-small-3'>
                                              {data.text}{' '}
                                            </p>
                                          </div>
                                        );
                                        ...
                                        return data.buttons.map(
                                          (data, index) => {
                                            if (data.type === 'URL') {
                                              return (
                                                <div
                                                  className='border-top  d-flex text-primary justify-content-center  align-items-center   '
                                                  style={{
                                                    padding: '10px',
                                                    gap: '8px',
                                                  }}
                                ...
                                if (data.type === 'BUTTONS') {
                                  return data.buttons.map((data, index) => {
                                    if (data.type === 'QUICK_REPLY') {
                                      return (
                                        <div
                                          className='border rounded-3 bg-white  d-flex text-primary justify-content-center  align-items-center   '
                                          style={{
                                            padding: '10px',
                                            gap: '8px',
                                          }}
                            ...
                            <div className='d-flex gap-2 flex-wrap '>
                              <Button
                                ...
                                style={{
                                  ...
                                  borderRadius: '3px',
                                  backgroundColor:
                                    SingleTemplate.status === 'APPROVED'
                                      ? 'green'
                                      : SingleTemplate.status === 'REJECTED'
                                      ? 'red'
                                      : SingleTemplate.status === 'PENDING'
                                      ? 'yellow'
                                      : 'white',
                                }}
                              >
                                {SingleTemplate.status}
                              </Button>
